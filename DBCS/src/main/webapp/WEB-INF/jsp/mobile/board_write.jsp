		...
		<div class="body">
			<form name="add_form">
				...
				<div class="btn_area">
					...
					<button type="button" class="save btn nt_save"><i class="ri-check-line"></i>저장</button> 
				</div>
			</form>
		</div>
	</div>
...
<script src="${resourcePath}/js/mobile/board_write.js"></script>
