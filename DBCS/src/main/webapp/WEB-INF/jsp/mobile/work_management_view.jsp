...
<div class="m_cont">
	<div class="m_work_write write m_work_view">
		<div class="top_area">
			<div class="top_tit">
				<p>콜관리 > <span>근무 상세보기</span></p>
			</div>
			<a class="btn gray back" href="${contextPath}/work_management"><i class="ri-arrow-go-back-line"></i></a>
		</div>
		<div class="body">
			<form name="call_work_edit" action="" method="">
						...
						<ul>
							...
							<li class="required">
								...
								<div class="sch_inp">
									...
									<input type="text" name="check_name" placeholder="검색하기" required="required" readonly>
							...
							<li class="required">
								...
								<div class="sch_inp">
									<input type="hidden" name="wrk_group" value="">
									<input type="text" name="group_name" placeholder="검색하기" required="required" readonly>
									<a class="btn" data-dialog="team_sch">
										<i class="ri-search-line"></i>
									</a>
								</div>
							...
							<li>
								...
								<div class="sch_inp">
									...
									<input type="text" name="text" placeholder="검색하기" readonly>
