...
<div class="container">
  ...
  <div class="panel panel-default">
      ...
      <table class="table table-bordered">
         ...
         <tr>
           <td colspan="2" style="text-align: center;">
              <c:if test="${!empty mvo}">
                <button data-btn="reply" class="btn btn-sm btn-primary">댓글</button>
                <button data-btn="modify" class="btn btn-sm btn-success">수정</button> 
              </c:if>
              <c:if test="${empty mvo}">
                <button disabled="disabled" class="btn btn-sm btn-primary">댓글</button>
    ...
    <div class="panel-footer">댓글게시판</div>
  </div>
</div>
