  ...
  <script type="text/javascript">
     ...
     function makeView(data){ // data=[{   },{    },{    },,, ]
    	 ...
    	 $.each(data, function(index,obj){ // obj={"idx":5,"title":"게시판"~~ }
        	 ...
        	 if("${mvo.memID}"==obj.memID){  //로그인ID와 게시물ID가 같으면 내용이 나온다
        	  listHtml+="<br/>";
    ...
    <div class="panel-body" id="wfrom" style="display: none">
     ...
     <!-- DB에 memID를 넘겨줘서 정보가 저장된다. -->
      ...
      <table class="table">
         ...
         <tr>
           <td>작성자</td>
           <td><input type="text" id="writer" name="writer" class="form-control" value="${mvo.memName}" readonly="readonly"/></td> <!-- 이름을 수정하지 못하도록 READONLY 처리한다. -->
         </tr>
         <tr>
